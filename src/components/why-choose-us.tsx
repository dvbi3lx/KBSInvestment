...
export function WhyChooseUs() {
    return (
        <section id="dlaczego-my" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50/30">
            <div className="mx-auto max-w-7xl px-4 lg:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    {reasons.map((reason, index) => (
                        <motion.div
                            ...
                            className="group"
                        >
                            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/20">
                ...
                <motion.div
                    ...
                    className="bg-white rounded-3xl p-8 lg:p-12 shadow-2xl border border-white/20"
                >
