                            ...
                            <div className="bg-white rounded-3xl p-8 shadow-2xl border border-white/20">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="font-medium text-gray-900">+48 570-751-670</p>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="font-medium text-gray-900">ul. Ks. Augustyna Strzybnego 4</p>
                                            <p className="text-sm text-gray-600">41-506 Chorzów, Polska</p>
                                        </div>
                                    </div>
