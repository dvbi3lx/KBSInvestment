...
export function CookieConsent() {
    ...
    return (
        <div className="fixed inset-0 z-[9999] p-2 sm:p-4 md:p-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Glassmorphism Background */}
            <div className="w-full h-full max-w-4xl mx-auto">
                <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/20 bg-white/95 backdrop-blur-md shadow-2xl h-full max-h-full flex flex-col">
                    ...
                    <div className="relative p-3 sm:p-4 md:p-6 lg:p-8 h-full flex flex-col">
                        ...
                        <div className="flex items-start justify-between mb-3 sm:mb-4 md:mb-6 flex-shrink-0">
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <div className="flex h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 items-center justify-center rounded-lg sm:rounded-xl bg-gradient-to-r from-primary to-blue-600 text-white shadow-lg hover:scale-110 hover:rotate-6 transition-transform duration-200">
                            ...
                            <button
                                ...
                                className="inline-flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center rounded-lg bg-gray-100 text-gray-500 hover:bg-gray-200 hover:text-gray-700 hover:scale-110 hover:rotate-90 active:scale-90 transition-all duration-200"
                            >
                        ...
                        <div className="flex-1 overflow-y-auto mb-3 sm:mb-4 md:mb-6">
                            <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                                        Ta strona internetowa <strong>nie używa plików cookie do śledzenia ani analityki</strong>.
                                        Używamy jedynie localStorage do zapisania Twojej zgody i preferencji interfejsu.
                                        Zgodnie z wymogami prawa (RODO), informujemy Cię o tym, jak chronimy Twoje dane osobowe.
                            </p>
                                ...
                                <div className="flex items-start space-x-2 sm:space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-blue-800 text-xs sm:text-sm">
                                            Nie śledzimy Twojej aktywności ani nie wysyłamy danych do zewnętrznych serwisów.
                                            Używamy tylko localStorage do zapisania Twoich preferencji lokalnie w przeglądarce.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                <div className="bg-green-50 border border-green-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
                                    ...
                                    <p className="text-green-800 text-xs sm:text-sm">
                                        Brak śledzenia, brak cookies analitycznych, pełna prywatność
                                    </p>
                                </div>
